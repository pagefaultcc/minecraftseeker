...
```
If you dont have a IP list yet, you can use a sample from [here](https://github.com/pagefaultcc/serverseeker/blob/main/samples/ips.txt).
This runs the scanner with 256 threads against the IP list in `ips.txt`, if you want to how it output's look [here](https://github.com/pagefaultcc/serverseeker/blob/main/samples/servers_rows.csv).
